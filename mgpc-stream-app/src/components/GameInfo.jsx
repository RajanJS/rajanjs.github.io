...
const GameInfo = ({ gameType, currentGamePoints, totalRounds, gameSettings }) => {
    ...
    <div className="game-info-modern">
      <div className="game-info-details">
        {/* <div className="info-item">
          ...
          <span className="info-value">{getGameModeName(gameType)} Game</span>
        </div> */}

        <div className="info-item">
          <span className="info-icon">{getGameModeIcon(gameType)}</span>
          <span className="info-label">Game Mode:</span>
          <span className="info-value">{gameSettings?.isMurder ? ' Murder ' : ' Kidnap '}</span>
        </div>
